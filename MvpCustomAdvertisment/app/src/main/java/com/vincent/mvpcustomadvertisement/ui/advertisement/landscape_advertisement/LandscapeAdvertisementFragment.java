package com.vincent.mvpcustomadvertisement.ui.advertisement.landscape_advertisement;
 ...
 * Use the {@link LandscapeAdvertisementFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LandscapeAdvertisementFragment extends BaseFragment implements AdvertisementMvpView {

    public LandscapeAdvertisementFragment() {
        // Required empty public constructor
    }

    private static final String TAG = "LandscapeAdvertisement";
    private int index = 0;
    ...
    @BindView(R.id.landscape_image_banner_1)
    Banner imgBannerA;
    @BindView(R.id.landscape_image_banner_2)
    Banner imgBannerB;
    @BindView(R.id.landscape_video_view)
    FullScreenVideoView videoView;

    public static LandscapeAdvertisementFragment newInstance() {
        LandscapeAdvertisementFragment fragment = new LandscapeAdvertisementFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_landscape_advertisement, container, false);
    ...
    protected void setUp(View view) {
        ...
        setUpBanner(imgBannerA);
        setUpBanner(imgBannerB);
...
//        Toast.makeText(this, response.toString(), Toast.LENGTH_LONG).show();
        ...
        List<AdvertisementResponse.ResponseImage> listBannerA = new ArrayList<AdvertisementResponse.ResponseImage>();
        List<AdvertisementResponse.ResponseImage> listBannerB = new ArrayList<AdvertisementResponse.ResponseImage>();

        for (AdvertisementResponse.ResponseImage responseImage : response.getImgList()) {
            if (responseImage.getPosition().equals("2"))
                listBannerB.add(responseImage);
            else if (responseImage.getPosition().equals("1"))
                listBannerA.add(responseImage);

        }

        imgBannerA.update(listBannerA);
        imgBannerB.update(listBannerB);
    ...
    public void onStart() {
        super.onStart();
        imgBannerA.startAutoPlay();
        imgBannerB.startAutoPlay();
        videoView.start();
    ...
    public void onStop() {
        super.onStop();
        imgBannerA.stopAutoPlay();
        imgBannerB.stopAutoPlay();
        videoView.stopPlayback();
    }
